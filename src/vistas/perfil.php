        ...
        <div class="card mb-4">
          <div class="card-body text-center">
            ...
            <div class="d-flex justify-content-center mb-2">
              ...
              <button type="button" data-mdb-button-init data-mdb-ripple-init
                class="btn btn-outline-success ms-1 " class="boton-succes "><a class="boton-succes " href="perfil_edit.php">Edit</a></button>
              <button type="button" data-mdb-button-init data-mdb-ripple-init
                class="btn btn-outline-danger ms-1 close-session-button" class="boton-danger"><a class="boton-danger" href="login.php">Close Session</a></button>
            </div>
          </div>
        </div>
